...
class Command(BaseCommand):
    help = 'Populate the database with sample data for Rural Opportunity Connect'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('✓ Created 5 Scholarships'))
        ...
        self.stdout.write(self.style.SUCCESS('✓ Created 5 Government Schemes'))
        ...
        self.stdout.write(self.style.SUCCESS('✓ Created 8 Skill Programs'))
        ...
        self.stdout.write(self.style.SUCCESS('✓ Created 8 Business Opportunities'))
